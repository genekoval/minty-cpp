...
namespace minty::sync::http {
    ...
    auto repo::add_objects_url(
        ...
        return client
            .add_objects_url(url)
            .json<std::vector<object_preview>>();
    }
    ...
    auto repo::add_related_post(
        ...
        client
            .add_related_post(post_id, related)
            .send();
    }
    ...
    auto repo::delete_post_objects(
        ...
        return client
            .delete_post_objects(post_id, objects)
            .json<time_point>();
    }
    ...
    auto repo::delete_post_tag(
        ...
        client
            .delete_post_tag(post_id, tag_id)
            .send();
    }
    ...
    auto repo::delete_related_post(
        ...
        client
            .delete_related_post(post_id, related)
            .send();
    }
    ...
    auto repo::delete_tag_source(
        ...
        client
            .delete_tag_source(tag_id, source_id)
            .send();
    }
    ...
    auto repo::get_posts(
        ...
        return client
            .get_posts(query)
            .json<search_result<post_preview>>();
    }
    ...
    ) -> search_result<tag_preview> {
        return client
            .get_tags(query)
            .json<search_result<tag_preview>>();
    }
    ...
    auto repo::set_post_description(
        ...
        return client
            .set_post_description(post_id, description)
    ...
    auto repo::set_tag_description(
        ...
        return client
            .set_tag_description(tag_id, description)
