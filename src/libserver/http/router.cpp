...
namespace minty::server::http {
    ...
    auto router(
        ...
        paths.insert("/object/url", post([&repo](
            std::string url
        ...
        paths.insert("/post/:post/title", put([&repo](
            path<"post", UUID::uuid> post_id,
            std::string title
        ...
        paths.insert("/post/:post/description", put([&repo](
            path<"post", UUID::uuid> post_id,
        ...
        paths.insert("/post/:post/related/:related",
            put([&repo](
                path<"post", UUID::uuid> post_id,
        ...
        paths.insert("/post/:post/tag/:tag",
            put([&repo](
                path<"post", UUID::uuid> post_id,
        ...
        paths.insert("/post/:post/objects",
            post([&repo](
                path<"post", UUID::uuid> post_id,
                std::vector<UUID::uuid> objects
            ) -> ext::task<time_point> {
                co_return co_await repo.add_post_objects(post_id, objects, {});
            }).
            del([&repo](
                path<"post", UUID::uuid> post_id,
                std::vector<UUID::uuid> objects
        ...
        paths.insert("/post/:post/objects/:destination", post([&repo](
            path<"post", UUID::uuid> post_id,
            path<"destination", UUID::uuid> destination,
            std::vector<UUID::uuid> objects
        ) -> ext::task<time_point> {
            co_return co_await repo.add_post_objects(
                post_id,
                objects,
                destination
            );
        ...
        paths.insert("/tag/:tag/name/:name",
            put([&repo](
                path<"tag", UUID::uuid> tag_id,
                path<"name"> new_name,
        ...
        paths.insert("/tag/:tag/description", put([&repo](
            path<"tag", UUID::uuid> tag_id,
            std::string description
        ...
        paths.insert("/tag/:tag/source", post([&repo](
            path<"tag", UUID::uuid> tag_id,
            std::string url
        ) -> ext::task<source> {
        ...
        paths.insert("/tag/:tag/source/:source", del([&repo](
            path<"tag", UUID::uuid> tag_id,
        ...
        paths.insert("/tags", get([&repo](
            query<"from", std::optional<std::uint32_t>> from,
            query<"size", std::optional<std::uint32_t>> size,
            query<"name", std::string> name,
            query<"exclude", std::optional<std::vector<UUID::uuid>>> exclude
