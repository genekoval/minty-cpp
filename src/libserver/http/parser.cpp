...
namespace http {
    auto parser<minty::post_sort_value>::parse(std::string_view string)
    ...
    auto parser<minty::sort_order>::parse(std::string_view string)
        -> minty::sort_order {
    ...
    auto parser<minty::visibility>::parse(std::string_view string)
        -> minty::visibility {
