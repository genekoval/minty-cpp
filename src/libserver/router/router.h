...
namespace minty::server {
    using router = zipline::router<
        ...
        decltype(&context::add_object_data),
        decltype(&context::add_object_local),
        decltype(&context::add_objects_url),
        decltype(&context::add_post),
        decltype(&context::add_post_objects),
        decltype(&context::add_post_tag),
        ...
        decltype(&context::move_post_object),
        decltype(&context::set_comment_content),
