...
namespace zipline {
    auto n::xfr<c::tag>::read(n::socket& sock) -> type {
        ...
        t.name= n::xfr<name_t>::read(sock);
        t.aliases = n::xfr<aliases_t>::read(sock);
        t.description = n::xfr<description_t>::read(sock);
        t.avatar = n::xfr<avatar_t>::read(sock);
        t.banner = n::xfr<banner_t>::read(sock);
        t.sources = n::xfr<sources_t>::read(sock);
        t.post_count = n::xfr<post_count_t>::read(sock);
        t.date_created = n::xfr<date_created_t>::read(sock);
