...
namespace minty::core {
    struct mock_repo : repo {
        MOCK_METHOD(
            ...
            add_comment,
            (const UUID::uuid& post_id, std::string_view content),
            (override)
        );
        ...
        MOCK_METHOD(
            ext::task<>,
            add_post_tag,
            (const UUID::uuid& post_id, const UUID::uuid& tag_id),
            (override)
        );
        ...
        MOCK_METHOD(
            ext::task<>,
            add_related_post,
            (const UUID::uuid& post_id, const UUID::uuid& related),
            (override)
        );
        ...
        MOCK_METHOD(
            ext::task<comment_data>,
            add_reply,
            (const UUID::uuid& parent_id, std::string_view content),
            (override)
        );
        ...
        MOCK_METHOD(
            ext::task<tag_name>,
            add_tag_alias,
            (const UUID::uuid& tag_id, std::string_view alias),
            (override)
        );
        ...
        MOCK_METHOD(
            ext::task<source>,
            add_tag_source,
            (const UUID::uuid& tag_id, std::string_view url),
            (override)
        );
        ...
        MOCK_METHOD(
            ext::task<time_point>,
            delete_post_objects,
            (const UUID::uuid& post_id, const std::vector<UUID::uuid>& objects),
            (override)
        );
        ...
        MOCK_METHOD(
            ext::task<std::size_t>,
            regenerate_previews,
            (unsigned int batch_size, unsigned int jobs, progress& progress),
            (override)
        );
        ...
        MOCK_METHOD(
            ext::task<std::string>,
            set_comment_content,
            (const UUID::uuid& comment_id, std::string_view content),
            (override)
        );
        ...
        MOCK_METHOD(
            ext::task<tag_name>,
            set_tag_name,
            (const UUID::uuid& tag_id, std::string_view new_name),
            (override)
        );
    };
}
